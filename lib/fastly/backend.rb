class Fastly::Backend
  ...
  attribute :ssl_ciphers, type: :string
  # Client certificate attached to origin.
  attribute :ssl_client_cert, type: :string
  # Client key attached to origin.
  attribute :ssl_client_key, type: :string
  # Used for both SNI during the TLS handshake and to validate the cert.
  attribute :ssl_hostname, type: :string
  # Overrides ssl_hostname, but only for SNI in the handshake. Does not affect cert validation at all.
  attribute :ssl_sni_hostname, type: :string

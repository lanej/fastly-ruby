...
class Fastly::CreateHealthcheck
  ...
  ACCEPTED_PARAMETERS = %w( check_interval comment expected_response host http_version initial method name path
                            service_id threshold timeout version window ).freeze
